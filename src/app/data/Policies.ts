...
/**
 * Static class holding all the valid Horrocubes policies.
 */
 export class Policies
 {
    /**
     * Gets whther the given policy id is a valid Horrocubes collectible.
     *
     * @param policyId The collectible policy id.
     *
     * @returns true if the policy is valid otherwise; false.
     */
    static isValidCollectible(policyId: string)
    {
        const cardIds = [
    ...
    /**
     * Gets whther the given policy id is a valid Horrocubes.
     *
     * @param policyId The Horrocubes policy id.
     *
     * @returns true if the policy is valid otherwise; false.
     */
    static isValidCube(policyId: string)
    {
        const cubeIds = [
